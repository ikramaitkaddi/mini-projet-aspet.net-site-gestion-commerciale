...
<body>
  ...
  <div class="card-body">
    ...
    <p class="card-text">Se connecter et  enrichir votre site par des nouveaux articles et catégories</p>
  </div>
</div>
                                </div> </div>
                </div>
        ...
        <div>
            <div class="auto-style2">
                <div class="auto-style3">
                    <asp:Login ID="Lgn1" runat="server" BackColor="#F7F7DE" BorderColor="#CCCC99" BorderStyle="Solid" BorderWidth="1px" CssClass="auto-style5" Font-Names="Verdana" Font-Size="10pt" Height="362px" OnAuthenticate="Login1_Authenticate" Width="1025px">
